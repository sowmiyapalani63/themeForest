...
import boxhouse4 from '../../Assests/images/section/box-house-4.jpg'
import boxhouse5 from '../../Assests/images/section/box-house-5.jpg'
import boxhouse6 from '../../Assests/images/section/box-house-6.jpg'
import boxhouse7 from '../../Assests/images/section/box-house-7.jpg'
import boxhouse8 from '../../Assests/images/section/box-house-8.jpg'
import boxhouse9 from '../../Assests/images/section/box-house-9.jpg'
// import boxhouse10 from '../../Assests/images/section/box-house-10.jpg'
// import boxhouse11 from '../../Assests/images/section/box-house-11.jpg'
                                    ...
                                    <div class="tab-paneactive show " id="gridLayout" role="tabpanel">
                                        <div class="tf-grid-layout lg-col-3 md-col-2">
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse}
                                                            src={boxhouse} alt="" />
                                                    </a>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse2}
                                                            src={boxhouse2} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse3}
                                                            src={boxhouse3} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse4}
                                                            src={boxhouse4} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse5}
                                                            src={boxhouse5} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse6}
                                                            src={boxhouse6} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse7}
                                                            src={boxhouse7} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse8}
                                                            src={boxhouse8} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse9}
                                                            src={boxhouse9} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse16}
                                                            src={boxhouse16} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src={boxhouse14}
                                                            src={boxhouse14} alt="" />
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
