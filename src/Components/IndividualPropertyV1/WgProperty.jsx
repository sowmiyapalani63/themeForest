         ...
         <div className="wg-property box-overview">
                                ...
                                <div className="info flex justify-between">
                                    <div className="feature">
                                        <p className="location text-1 flex items-center gap-10">
                                            <i className="icon-location"></i>102 102 Ingraham St, Brooklyn, NY 11237
                                        </p>
                                        <ul className="meta-list flex">
                                            <li className="text-1 flex"><span>3</span>Bed</li>
                                            <li className="text-1 flex"><span>3</span>Bath</li>
                                ...
                                <div className="info-detail ">
                                    ...
                                    <div className="wrap-box">
                                        <div className="box-icon">
                                            <div className="icons">
                                                <i className="icon-SlidersHorizontal"></i>
                                            </div>
                                            <div className="content">
