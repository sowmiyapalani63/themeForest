...
import comment1 from '../../Assests/images/blog/comment-1.jpg'
import comment2 from '../../Assests/images/blog/comment-2.jpg'
import comment3 from '../../Assests/images/blog/comment-3.jpg'
import avatar1 from '../../Assests/images/avatar/avatar-1.jpg'
import avatar2 from '../../Assests/images/avatar/avatar-2.jpg'
import avatar3 from '../../Assests/images/avatar/avatar-3.jpg'
            ...
            <div className="wg-property mb-0 box-comment">
                <div className="wrap-comment">
                    ...
                    <a href="#" className="tf-btn style-border fw-7 pd-1">
                        <span>View all reivew <i className="icon-arrow-right-2 fw-4
                                            "></i></span>
                    </a>
                </div>
                    ...
                    <form className="form-add-review">
                        <div className="cols">
                            <fieldset className="name">
                                <label className="text-1 fw-6 " for="name">Name</label>
                                <input type="text" className="tf-input style-2" placeholder="Your Name*"
                                    tabindex="2" aria-required="true" id="name" name="name" required />
                            </fieldset>
                            <fieldset className="email">
                                <label className="text-1 fw-6" for="email">Email</label>
                                <input type="email" className="tf-input style-2" placeholder="Your Email*"
                                    tabindex="2" aria-required="true" id="email1" name="email" required />
                            </fieldset>
                        </div>
                        <div className="checkbox-item style-1">
                            <label>
                                <span className="text-1 fw-4">Save your name, email for the next time
                                    review</span>
                                <input type="checkbox" />
                        ...
                        <fieldset className="message">
                            <label className="text-1 fw-6" for="message">Review</label>
                            <textarea id="message" className="tf-input" name="message" rows="4"
