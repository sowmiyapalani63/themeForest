                ...
                <div class="row">
                    <div class="col-12">
                        <div class="heading-section text-center mb-48">
                            <SplitText
                                text="Selling Your Home With Realty"
                            ...
                            >
                                <p
                                    ...
                                    We'll get to know you to understand your selling
                                    goals, and explain
                        ...
                        <div class="tf-grid-layout lg-col-4 sm-col-2 ">
                            <div
                                ref={cardRef}
                                className={`icons-box style-4 effec-icon ${isVisible ? 'animate__animated animate__zoomIn' : ''}`}
                            >
